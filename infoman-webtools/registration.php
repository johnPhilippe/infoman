<!DOCTYPE html>
 ...
 <?php 
    ...
    if (isset($_REQUEST['username'])) {
        ...
        $query = "INSERT INTO tbl_users(username, password, email, userType, first_Name, last_Name, city, phone_Num ) VALUES('$username', '$password', '$email', '$userType', '$first_Name', '$last_Name', '$city', '$phone_Num')";
